...
if __name__ == '__main__':
    import sys
    sys.path.append('..')
from fem.geom_mltdim import *
import numpy as np
import matplotlib.pyplot as plt
#from mpl_toolkits import mplot3d
from fem.qrule_mltdim import * 
from fem.qrule_onedim import * 
from fem.poly_mltdim import * 

class LocalFunctionSpace(object):
    '''
    Class representing a local function space.

    Parameters:
    - polysp (str): The type of polynomial space. Supported values are 'P' for simplex and 'Q' for hypercube.
    - nsd (int): The number of spatial dimensions.
    - porder (int): The polynomial order.
    - qrule0 (str): The quadrature rule for the reference volume. Default is 'gl'.
    - nq0 (int): The number of quadrature points for the reference volume. Default is None.

    Attributes:
    - nsd (int): The number of spatial dimensions.
    - porder (int): The polynomial order.
    - desc (str): The type of polynomial space.
    - nf (int): The number of face nodes.
    - geom (object): The geometry object.
    - rk (ndarray): The reference coordinates.
    - nq0 (int): The number of quadrature points for the reference volume.
    - wqd (ndarray): The quadrature weights for the reference edge.
    - sq (ndarray): The quadrature nodes for the reference edge.
    - wqf (ndarray): The quadrature weights for the reference face.
    - rq (ndarray): The quadrature nodes for the reference face.
    - wqv (ndarray): The quadrature weights for the reference volume.
    - zq (ndarray): The quadrature nodes for the reference volume.
    - zqd (ndarray): The quadrature nodes for the reference edge.
    - zqf (ndarray): The quadrature nodes for the reference face.
    - Qvd (ndarray): The basis functions over volume evaluated at quadrature on edge.
    - Qvf (ndarray): The basis functions over volume evaluated at quadrature on face.
    - Qvv (ndarray): The basis functions over volume evaluated at quadrature on volume.
    - Qf (ndarray): The basis functions over face evaluated at quadrature on face.

    Methods:
    - eval_basis_functions(z, zk0=None): Evaluate the basis functions at the given quadrature nodes.
